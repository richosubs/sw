...
fpga -file C:/Users/richo/ws/sys/sw/workspace/app_prj_base/_ide/bitstream/prj_base.bit
targets -set -nocase -filter {name =~"APU*"}
...
set bp_11_38_fsbl_bp [bpadd -addr &XFsbl_Exit]
con -block -timeout 60
bpremove $bp_11_38_fsbl_bp
