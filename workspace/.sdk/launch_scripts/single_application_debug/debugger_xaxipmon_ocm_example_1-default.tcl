...
fpga -file C:/Users/richo/ws/sys/sw/workspace/xaxipmon_ocm_example_1/_ide/bitstream/prj_base.bit
targets -set -nocase -filter {name =~"APU*"}
...
set bp_26_20_fsbl_bp [bpadd -addr &XFsbl_Exit]
con -block -timeout 60
bpremove $bp_26_20_fsbl_bp
targets -set -nocase -filter {name =~ "*A53*#0"}
rst -processor
dow C:/Users/richo/ws/sys/sw/workspace/xaxipmon_ocm_example_1/Debug/xaxipmon_ocm_example_1.elf
